    ...
    <div className="fixed bottom-[80px] left-4 z-40 md:bottom-8 w-72 max-w-[calc(100vw-2rem)] rounded-2xl bg-white shadow-2xl border border-stone-100 overflow-hidden animate-chat-slide">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-3 mb-3">
          <img src="/images/logo.jpg" alt="App icon" className="w-12 h-12 object-contain rounded-xl border border-stone-100 p-1" />
          <div>
            <p className="font-bold text-stone-800 text-sm leading-tight">Awake Grace Ministries</p>
            <p className="text-amber-500 text-xs">International – UK</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-sky-500 hover:bg-sky-400 text-white text-sm font-semibold rounded-xl transition-colors"
          >
            <Download size={15} />
            Install App
          </button>
