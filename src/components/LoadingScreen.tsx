...
export default function LoadingScreen() {
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#07102b] transition-opacity duration-500"
      style={{ opacity: fading ? 0 : 1 }}
    >
      <img
        src="/images/logo.jpg"
        alt="Awake Grace Ministries"
      ...
      <p className="mt-4 text-stone-400 text-xs tracking-widest uppercase font-medium">
        Awakening Grace • Building Faith
      </p>
    </div>
  );
}
